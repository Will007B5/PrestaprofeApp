                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Icon(Icons.payment_rounded, size: _objectSize * 0.00024, color: Color.fromARGB(255, 238, 195, 67)),
                                Text('VER/PAGAR PRÉSTAMO', style: TextStyle(color: Colors.white, fontSize: _textWidth * 0.05, fontWeight: FontWeight.bold)),
                              ],
                            ),
                          ),
                        ],
                        ...
                        child: Container(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              children: [
                                SizedBox(height: 20),
                                Text('${_authService.currentClient.name}', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _textWidth * 0.065, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                                SizedBox(height: 5),
                                Icon(Icons.info, size: _objectSize * 0.00024, color: Colors.green[300]),
                                SizedBox(height: 5),
                                Text('ACTUALMENTE CUENTA CON EL SIGUIENTE PRÉSTAMO', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _textWidth * 0.039, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                                SizedBox(height: 20),
                                Container(
                                                    ...
                                                    Row(
                                                      children: [
                                                        Container(
                                                          ...
                                                          child: Text('\$', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _width * 0.039, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                                        ),
                                                        Container(
                                                          alignment: Alignment.center,
                                                          child: Text('537', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _width * 0.067, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                                        ),
                                                        Container(
                                                          child: Text('00', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _width * 0.039, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                                        ),
                                                      ],
                                                    ),
                                                    Text('Creada el 10/Marzo',
                                            ...
                                            TableRow(
                                              children: [
                                                Container(
                                                  ...
                                                  child: Text('TASA DE INTERÉS QUINCENAL', style: TextStyle(color: Colors.black87, fontSize: _textWidth * 0.027, fontWeight: FontWeight.bold))
                                                ),
                                                Container(
                                                  margin: EdgeInsets.only(bottom: 3),
                                                ),
                                            ...
                                            TableRow(
                                              children: [
                                                Container(
                                                  ...
                                                  child: RichText(//Crea un parrafo de texto enriquecido
                                                    text: TextSpan(
                                                ...
                                                Container(
                                                  margin: EdgeInsets.only(bottom: 8),
                                                  child: Text('\$37.70', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _textWidth * 0.029), textAlign: TextAlign.end)
                                                ),
                                              ]
                                            ),
                                            TableRow(
                                              children: [
                                                Container(
                                                  child: Text('1 PAGO QUINCENAL DE', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _textWidth * 0.031, fontWeight: FontWeight.bold))
                                                ),
                                                Container(
                                                  child: Text('\$537.70', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _textWidth * 0.033), textAlign: TextAlign.end)
                                                ),
                                              ]
                                            ),
                                          ],
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Container(
                                                      alignment: Alignment(0, 0.17),
                                                      child: Text('\$', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _width * 0.076, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                                    ),
                                                    Container(
                                                      alignment: Alignment.center,
                                                      child: Text('537', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _width * 0.1, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                                    ),
                                                    Container(
                                                      child: Text('00', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _width * 0.076, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                                    ),
                                                  ],
                                                ),
                                                SizedBox(height: 5),
                                                  ...
                                                  child: RichText(//Crea un parrafo de texto enriquecido
                                                    ...
                                                    text: TextSpan(
                                                      ...
                                                      children: [
                                                        ...
                                                        TextSpan(text: '3 días de atraso; interés moratorio - \$16.53', style: TextStyle(color: Colors.red)),
                                                      ],
                                                    ),
                                                  ),
                                                ),
                                        ...
                                        child: Container(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              SizedBox(height: 3),
                                              RichText(//Crea un parrafo de texto enriquecido
                                                text: TextSpan(
                                                  // Nota: Los estilos de los TextSpans deben ser definidos explicitamente.
                                                  // Los elementos child del textspan heredarán los estilos del padre
                                                  style: TextStyle(
                                                  ...
                                                  children: [
                                                    ...
                                                    TextSpan(text: '2 ', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1))),
                                                        ...
                                                        children: [
                                                              ...
                                                              Expanded(
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Container(
                                                                      alignment: Alignment(0, 0.17),
                                                                      child: Text('\$', style: TextStyle(color: Color.fromRGBO(2, 158, 51, 1), fontSize: _width * 0.036, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                                                    ),
                                                                    Container(
                                                                      alignment: Alignment.center,
                                                                      child: Text('537', style: TextStyle(color: Color.fromRGBO(2, 158, 51, 1), fontSize: _width * 0.064, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                                                    ),
                                                                    Container(
                                                                      child: Text('00', style: TextStyle(color: Color.fromRGBO(2, 158, 51, 1), fontSize: _width * 0.036, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                                                    ),
                                                                  ],
                                                                ),
                                                              ),
                                                          ...
                                                          Row(
                                                            children: [
                                                              Expanded(
                                                                child: Container(
                                                                  child: Text('Interés + \$60.00 MXN extensión',
                                                                    textAlign: TextAlign.end,
                                                                    overflow: TextOverflow.ellipsis,
                                                                    maxLines: 3,
                                                                    style: TextStyle(
