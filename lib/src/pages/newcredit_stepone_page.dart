                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Icon(Icons.payments_rounded, size: _objectSize * 0.00024, color: Color.fromARGB(255, 238, 195, 67)),
                                Text('SOLICITAR PRÉSTAMO', style: TextStyle(color: Colors.white, fontSize: _textWidth * 0.05, fontWeight: FontWeight.bold)),
                              ],
                            ),
                          ),
                        ],
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Container(
                                      width: _width * 0.6,
                                      child: IntrinsicHeight( //Se combina este widget con el Cross.stretch para que los containers hijos sean del mismo alto que la row
                                        child: Row(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Text('\$', style: TextStyle(color: Color.fromRGBO(2, 158, 51, 1), fontSize: _textWidth * 0.0487, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                            ),
                                            Container(
                                              alignment: Alignment.center,
                                              child: Text('${_newCreditFormProvider.amountSliderRange.toStringAsFixed(0)}', style: TextStyle(color: Color.fromRGBO(2, 158, 51, 1), fontSize: _textWidth * 0.076, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                            ),
                                            Container(
                                              child: Text('00', style: TextStyle(color: Color.fromRGBO(2, 158, 51, 1), fontSize: _textWidth * 0.0487, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                            ),
                                          ],
                                        ),
                                      ),
                                ...
                                SliderTheme(
                                  data: SliderThemeData(
                                    ...
                                    thumbShape: CustomSliderThumbCircle(thumbRadius: 16, colorShape: Color.fromRGBO(51, 114, 134, 1), colorIcon: Color.fromARGB(255, 238, 195, 67)), //Clase custom para poner el icono
                                      ...
                                      child: Table(
                                        children: [
                                          ...
                                          TableRow(
                                            children: [
                                              Container(
                                                child: Text('TOTAL A PAGAR', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _textWidth * 0.051, fontWeight: FontWeight.bold))
                                              ),
                                              Container(
                                                child: Text('\$${_newCreditFormProvider.totalLoanAmount(paymentSchema: _newCreditFormProvider.loan.paymentSchema, paymentSchemaDaysDuration: _newCreditFormProvider.paymentSchemaDaysDuration)}', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _textWidth * 0.051, fontWeight: FontWeight.bold), textAlign: TextAlign.end)
                                              ),
                                            ]
                                          ),
                                        ],
                                    ...
                                    Container(
                                      ...
                                      child: MaterialButton(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              _loansService.isLoading ? 'Generando prestamo...' : 'SOLICITAR',
                                              style: TextStyle(
                                                color: Colors.white,
                                                fontWeight: FontWeight.bold
                                              )
                                            ...
                                            Text(
                                              _loansService.isLoading ? 'Generando prestamo...' : 'PRÉSTAMO',
                                              style: TextStyle(
...
class CustomSliderThumbCircle extends SliderComponentShape {
  ...
  void paint(
    ...
    TextSpan span = new TextSpan(
      ...
      text: String.fromCharCode(0x2B), //charcode sacado de documentación flutter
    );
