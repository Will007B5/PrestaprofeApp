                              ...
                              children: [
                                ...
                                TableRow(
                                  children: [
                                    Container(
                                      margin: EdgeInsets.only(bottom: 8),
                                      //child: Text('3.5% INTERÉS + 1.75% INTERÉS POR APERTURA DE CTA. + 1.5% INTERÉS POR MANEJO DE CTA. + IVA = .70 X 1 QUINCENA', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: _textWidth * 0.027, fontWeight: FontWeight.bold))
                                      child: RichText(
