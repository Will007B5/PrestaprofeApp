        ...
        children: [
          ...
          Column(
            children: [
              ...
              SizedBox(height: 2),
              Text('${_authService.currentClient.name.toUpperCase()}',
                overflow: TextOverflow.ellipsis,
                maxLines: 1,
                textAlign: TextAlign.center,
                style: TextStyle(
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Expanded(child: _GestureTapMenuActions(route: _checkRoutesToNewLoans(_cardsService.filterUserCards(_authService.currentClient.id!)), icon: Icons.payments_rounded, width: (this.width / 3), height: (this.height / 3), text: 'SOLICITAR PRÉSTAMO')),
                Expanded(child: _GestureTapMenuActions(route: 'myCredits', icon: Icons.payment_rounded, width: (this.width / 3), height: (this.height / 3), text: 'VER/PAGAR PRÉSTAMO')),
                Expanded(child: _GestureTapMenuActions(route: '', icon: Icons.insert_chart, width: (this.width / 3), height: (this.height / 3), text: 'MI HISTORIAL')),
              ],
            ),
          ),
          SizedBox(height: 5),
                      ...
                      RichText(//Crea un parrafo de texto enriquecido
                        text: TextSpan(
                          ...
                          children: [
                            ...
                            TextSpan(text: '8 días ', style: TextStyle(color: Colors.red)),
                          ],
                        ),
                      ),
                    ],
                        ...
                        Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: Text('\$', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: width * 0.039, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                            ),
                            Container(
                              alignment: Alignment.center,
                              child: Text('537', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: width * 0.067, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                            ),
                            Container(
                              child: Text('00', style: TextStyle(color: Color.fromRGBO(51, 114, 134, 1), fontSize: width * 0.039, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                            ),
                          ],
                        ),
                        Row(
                                        ...
                                        Expanded(
                                          child: Row(
                                            ...
                                            children: [
                                              Container(
                                                alignment: Alignment(0, 0.17),
                                                child: Text('\$', style: TextStyle(color: Color.fromRGBO(2, 158, 51, 1), fontSize: width * 0.036, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                              ),
                                              Container(
                                                alignment: Alignment.center,
                                                child: Text('537', style: TextStyle(color: Color.fromRGBO(2, 158, 51, 1), fontSize: width * 0.064, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                              ),
                                              Container(
                                                child: Text('00', style: TextStyle(color: Color.fromRGBO(2, 158, 51, 1), fontSize: width * 0.036, fontWeight: FontWeight.w900), textAlign: TextAlign.end)
                                              ),
                                            ],
                                          ),
                                        ),
            ...
            child: Column(
              children: [
                Container(
                  child: Stack(
                    children: [
                      Icon(this.icon, color:Color.fromARGB(255, 247, 214, 118), size: (this.height * this.width) * 0.0019),
                      Positioned.fill(
                        left: MediaQuery.of(context).size.width / 180, //2.3
                        bottom: MediaQuery.of(context).size.height / 1300, //0.2
                        child: Icon(this.icon, color: Color.fromRGBO(51, 114, 134, 1), size: (this.height * this.width) * 0.00175)
                      )
                    ]
                  ),
                ),
